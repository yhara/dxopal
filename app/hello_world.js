...
(function(Opal) {
  ...
  var $a, $b, TMP_17, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, x = nil, dx = nil;

  Opal.add_stubs(['$require', '$_init_ctx', '$now', '$call', '$_draw_box_fill', '$each', '$[]', '$===', '$_draw_circle', '$drop', '$_draw_circle_fill', '$sort_by', '$to_proc', '$/', '$-', '$loop', '$push', '$_rgb', '$length', '$raise', '$inspect', '$+', '$join', '$include', '$<', '$>', '$width', '$-@', '$draw_circle', '$draw_circle_fill']);
  self.$require("opal");
  (function($base) {
    ...
    (function($base) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16;

      (Opal.cvars['@@fps'] = 60);

      (Opal.cvars['@@width'] = 640);

      (Opal.cvars['@@height'] = 480);

      Opal.defs(self, '$loop', TMP_1 = function $$loop() {
        var $a, $b, TMP_2, $c, $d, $e, self = this, $iter = TMP_1.$$p, block = $iter || nil, t0 = nil, dt = nil, wait = nil;

        TMP_1.$$p = null;
        ((($a = (($b = Opal.cvars['@@ctx']) == null ? nil : $b)) !== false && $a !== nil && $a != null) ? $a : (Opal.cvars['@@ctx'] = self.$_init_ctx((($b = Opal.cvars['@@width']) == null ? nil : $b), (($b = Opal.cvars['@@height']) == null ? nil : $b))));
        t0 = $scope.get('Time').$now();
        (Opal.cvars['@@draw_queue'] = []);
        block.$call();
        self.$_draw_box_fill(0, 0, (($a = Opal.cvars['@@width']) == null ? nil : $a), (($a = Opal.cvars['@@height']) == null ? nil : $a), [0, 0, 0]);
        ($a = ($b = ($c = ($d = (($e = Opal.cvars['@@draw_queue']) == null ? nil : $e)).$sort_by, $c.$$p = "first".$to_proc(), $c).call($d)).$each, $a.$$p = (TMP_2 = function(item){var self = TMP_2.$$s || this, $c, $d, $case = nil;
if (item == null) item = nil;
        return (function() {$case = item['$[]'](1);if ("circle"['$===']($case)) {return ($c = self).$_draw_circle.apply($c, Opal.to_a(item.$drop(2)))}else if ("circle_fill"['$===']($case)) {return ($d = self).$_draw_circle_fill.apply($d, Opal.to_a(item.$drop(2)))}else { return nil }})()}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($b);
        dt = $rb_divide(new Date() - t0, 1000);
        wait = $rb_minus(($rb_divide(1000, (($a = Opal.cvars['@@fps']) == null ? nil : $a))), dt);
        return setTimeout(function(){ ($a = ($c = self).$loop, $a.$$p = block.$to_proc(), $a).call($c) }, wait);
      }, TMP_1.$$arity = 0);

      Opal.defs(self, '$fps', TMP_3 = function $$fps() {
        var $a, self = this;

        return (($a = Opal.cvars['@@fps']) == null ? nil : $a);
      }, TMP_3.$$arity = 0);

      Opal.defs(self, '$fps=', TMP_4 = function(w) {
        var self = this;

        return (Opal.cvars['@@fps'] = w);
      }, TMP_4.$$arity = 1);

      Opal.defs(self, '$width', TMP_5 = function $$width() {
        var $a, self = this;

        return (($a = Opal.cvars['@@width']) == null ? nil : $a);
      }, TMP_5.$$arity = 0);

      Opal.defs(self, '$width=', TMP_6 = function(w) {
        var self = this;

        return (Opal.cvars['@@width'] = w);
      }, TMP_6.$$arity = 1);

      Opal.defs(self, '$height', TMP_7 = function $$height() {
        var $a, self = this;

        return (($a = Opal.cvars['@@height']) == null ? nil : $a);
      }, TMP_7.$$arity = 0);

      Opal.defs(self, '$height=', TMP_8 = function(h) {
        var self = this;

        return (Opal.cvars['@@height'] = h);
      }, TMP_8.$$arity = 1);

      Opal.defs(self, '$draw_circle', TMP_9 = function $$draw_circle(x, y, r, color, z) {
        var $a, self = this;

        if (z == null) {
          z = 0;
        }
        return (($a = Opal.cvars['@@draw_queue']) == null ? nil : $a).$push([z, "circle", x, y, r, color]);
      }, TMP_9.$$arity = -5);

      Opal.defs(self, '$draw_circle_fill', TMP_10 = function $$draw_circle_fill(x, y, r, color, z) {
        var $a, self = this;

        if (z == null) {
          z = 0;
        }
        return (($a = Opal.cvars['@@draw_queue']) == null ? nil : $a).$push([z, "circle_fill", x, y, r, color]);
      }, TMP_10.$$arity = -5);

      Opal.defs(self, '$_init_ctx', TMP_11 = function $$_init_ctx(w, h) {
      ...
      Opal.defs(self, '$_draw_box_fill', TMP_12 = function $$_draw_box_fill(x1, y1, x2, y2, color) {
        var $a, self = this, ctx = nil;

        ctx = (($a = Opal.cvars['@@ctx']) == null ? nil : $a);
        
        ctx.beginPath();
        ctx.fillStyle = self.$_rgb(color);
        ctx.fillRect(x1, y1, x2-x1, y2-y1); 
      
      }, TMP_12.$$arity = 5);

      Opal.defs(self, '$_draw_circle', TMP_13 = function $$_draw_circle(x, y, r, color) {
        var $a, self = this, ctx = nil;

        ctx = (($a = Opal.cvars['@@ctx']) == null ? nil : $a);
        
        ctx.beginPath();
        ctx.strokeStyle = self.$_rgb(color);
        ctx.arc(x, y, r, 0, Math.PI*2, false)
        ctx.stroke();
      
      }, TMP_13.$$arity = 4);

      Opal.defs(self, '$_draw_circle_fill', TMP_14 = function $$_draw_circle_fill(x, y, r, color) {
        var $a, self = this, ctx = nil;
      ...
      Opal.defs(self, '$_rgb', TMP_15 = function $$_rgb(color) {
        var self = this, $case = nil, rgb = nil;

        $case = color.$length();if ((4)['$===']($case)) {rgb = color['$[]'](1, 3)}else if ((3)['$===']($case)) {rgb = color}else {self.$raise("invalid color: " + (color.$inspect()))};
        return $rb_plus($rb_plus("rgb(", rgb.$join(", ")), ")");
      }, TMP_15.$$arity = 1);

      Opal.defs(self, '$_rgba', TMP_16 = function $$_rgba(color) {
        var self = this, $case = nil, rgba = nil;

        $case = color.$length();if ((4)['$===']($case)) {rgba = $rb_plus(color['$[]'](3), color['$[]'](1, 3))}else if ((3)['$===']($case)) {rgba = $rb_plus(color, [255])}else {self.$raise("invalid color: " + (color.$inspect()))};
        return $rb_plus($rb_plus("rgba(", rgba.$join(", ")), ")");
      }, TMP_16.$$arity = 1);
    })($scope.base)
  })($scope.base);
  self.$include($scope.get('DXOpal'));
  x = 0;
  dx = 5;
  return ($a = ($b = $scope.get('Window')).$loop, $a.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this, $c, $d;

  x = $rb_plus(x, dx);
    if ((($c = ((($d = $rb_lt(x, 0)) !== false && $d !== nil && $d != null) ? $d : $rb_gt(x, $scope.get('Window').$width()))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
      dx = dx['$-@']()};
    $scope.get('Window').$draw_circle(x, 100, 20, [128, 255, 255, 255]);
    return $scope.get('Window').$draw_circle_fill(100, 100, 10, [10, 100, 30]);}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17), $a).call($b);
})(Opal);
